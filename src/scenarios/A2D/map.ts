    ...
    locations: {
        ...
        24: {
            ...
            landmarks: [{
                ...
                text: [
                    " )~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~(",
                    "(   Welcome to the Hearty Domain of the fighters    )",
                    "(   of Ierdale.  learning from Ieadon is the best   )",
                    "(           expierience you will have.              )",
                    "(                                                   )",
                    "(  At the domain of Ieadon we teach the following:  )",
                    "(     train toughness   | increaces HP              )",
                    "(     train strength    | increases attack damage   )",
                    "(     train stamina     | increases SP              )",
                    "(                                                   )",
                    "(  To train any of these, please type 'train' then  )",
                    "(             type what to train.                   )",
        ...
        78: {
            ...
            landmarks: [{
                ...
                text: [
                    ...
                    "&      At the domain of Mythin we teach        )",
                    "(           the following:                     =",
                    "!                                              .",
                    "}    train coordination | increaces to-hit     ^",
                    "*    train agility      | improves dodging     /",
                    "^    train offhand      | left-hand power      =",
                    "!                                              .",
                    "l  To train any of these, please type 'train'  {",
                    "|  then type what to train Please be warned I  |",
                    "I  only accept serious students.               *",
                    "!                                              .",
                    "-  ANY knowladge of the ware-abouts of this    -",
                    "$  place given to the king police, or any      =",
                    "~  other of his men WILL result in severe      ^",
                    "`  consequences.                               @",
        ...
        109: {
            ...
            landmarks: [{
                ...
                text: [
                    "+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+",
                    "+                                                                           +",
                    "+          Welcome to My Cottage! Please make yourself at home.             +",
                    "+          I know that is a long trip out here,  and so for your            +",
                    "+          convenience I will transport you back to town free of            +",
                    "+          cost.  Type 'transport' to have me do so.                        +",
                    "+                                                                           +",
                    "+                         Thankyou, Eldin                                   +",
                    "+                                                                           +",
                    "+ At the Cottage of Eldin we teach the following:                           +",
                    "+ train newbie        | a basic magical attack, uses little BP              +",
                    "+ train bolt          | a fast and and accurate lightning attack, 1 target  +",
                    "+ train fire          | slower but more powerful, can hit 2 or 3 targets    +",
                    "+ train blades        | a sharp and deadly storm, can hit several enemies   +",
                    "+ train bloodlust     | temporarily raises your strength and coordination   +",
                    "+ train shield        | while active, all damage is reduced                 +",
                    "+ train powermaxout   | empty your reserves, sweeping all before you        +",
                    "+ train magic         | increases magical power                             +",
                    "+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+"
                ]
            }]
        },
        ...
        316: {
            ...
            landmarks: [{
                ...
                text: [
                    ...
                    "|                                                   |",
                    "|  This room is intendended for hard core students, |",
                    "|  any playing aroung will have you strictly banned |",
                    "|  from this classroom.  Eldfarl only acceptps the  |",
                    "|  best... Good Luck.                               |",
                    "|                                                   |",
                    "|  At the domain of Eldfarl we teach the following: |",
                    "|>><><><><><><><><><><><><!><><><><><><><><><><><><<|",
                    "|    train mindfulness | increaces BP               |",
                    "|    train healing     | increases healing power    |",
                    "|    train archery     | increases archery skills   |",
                    "|                                                   |",
                    "|    To train any of these, please type 'train'     |",
                    "|              type what to train.                  |",
                    "|                                   |",
                    " (-)-(-)-(-)-(-)-(-)-(-)-(-)-(-)-(-)-(-)-(-)-(-)-(-)",
                ]
